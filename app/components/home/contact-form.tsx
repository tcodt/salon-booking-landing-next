...
export default function ContactForm() {
  ...
  return (
    <section className="py-24 px-6 bg-surface-home">
      <div className="max-w-container-max mx-auto flex flex-col md:flex-row gap-16">
        <div className="flex-1 reveal-up active">
          <h1 className="font-headline-lg text-headline-lg text-center text-primary-home mb-xl">
            با ما در ارتباط باشید
          </h1>
          <p className="font-body-lg text-body-lg text-on-surface-variant-home mb-12">
            آماده‌اید تا کسب‌وکار خود را متحول کنید؟ فرم را پر کنید تا کارشناسان
            ما با شما تماس بگیرند.
          </p>
          <div className="flex items-center gap-6 mb-8">
            <div className="w-14 h-14 bg-primary-home text-on-primary rounded-full flex items-center justify-center shadow-lg animate-bounce">
        ...
        <div className="flex-1 bg-white p-10 rounded-3xl shadow-xl border border-outline-variant/20 reveal-up active">
          <form onSubmit={handleSubmit} className="space-y-10">
            <div className="relative">
              <input
                className="floating-label-input w-full bg-transparent border-0 border-b-2 border-outline-variant focus:ring-0 focus:border-primary-home transition-colors py-2 px-0"
                id="name"
                placeholder=" "
                type="text"
                value={formData.name}
              ...
              />
              <label
                className="absolute right-0 top-2 text-on-surface-variant-home transition-all duration-300 pointer-events-none"
                htmlFor="name"
              >
                نام و نام خانوادگی
              </label>
            ...
            <button
              className="w-full bg-primary-home text-on-primary py-4 rounded-xl font-bold text-lg hover:shadow-2xl active:scale-95 transition-all duration-400"
              type="submit"
            >
              ارسال پیام
            </button>
